...
int main(){
	...
	recycler->set_variable_opt(hidden_p->variable_opt, D_boolean(true));
	...
	recycler->set_variable_opt(one->variable_opt, D_integer(42));
	lref = { one };
	...
	recycler->set_variable_opt(hidden_c->variable_opt, D_string("hello"));
	lref = { hidden_c };
	...
	recycler->set_variable_opt(two->variable_opt, D_array(5));
	lref = { two };
