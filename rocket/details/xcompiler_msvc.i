...
#define ROCKET_CONSTANT_P(...)      0  // not implemented
...
#define ROCKET_ADD_OVERFLOW(x,y,r)    @@ unimplemented @@
#define ROCKET_SUB_OVERFLOW(x,y,r)    @@ unimplemented @@
#define ROCKET_MUL_OVERFLOW(x,y,r)    @@ unimplemented @@

// MSVC supports only little-endian platforms.
