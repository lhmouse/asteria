...
template tinyfmt& formatv(tinyfmt&, const char*, const formatter*, size_t);
template wtinyfmt& formatv(wtinyfmt&, const wchar_t*, const wformatter*, size_t);
template u16tinyfmt& formatv(u16tinyfmt&, const char16_t*, const u16formatter*, size_t);
template u32tinyfmt& formatv(u32tinyfmt&, const char32_t*, const u32formatter*, size_t);
