...
#ifndef ASTERIA_ROCKET_UNIQUE_PTR_
#define ASTERIA_ROCKET_UNIQUE_PTR_
...
class unique_ptr
  ...
  public:
    ...
    ASTERIA_ENABLE_IF(is_convertible<typename unique_ptr<yelementT,
                                     ydeleterT>::pointer, pointer>::value),
    ASTERIA_ENABLE_IF(is_constructible<deleter_type,
    ...
    ASTERIA_ENABLE_IF(is_convertible<typename unique_ptr<yelementT,
                                     ydeleterT>::pointer, pointer>::value),
    ASTERIA_ENABLE_IF(is_assignable<deleter_type&,
             typename unique_ptr<yelementT, ydeleterT>::deleter_type&&>::value)>
    unique_ptr&
