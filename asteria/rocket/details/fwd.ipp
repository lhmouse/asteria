...
#  error Please include <asteria/fwd.hpp> instead.
#endif
...
struct is_input_iterator_aux<iteratorT,
             ASTERIA_VOID_DECLTYPE(static_cast<::std::input_iterator_tag>(
...
struct can_static_cast<targetT, sourceT,
           ASTERIA_VOID_DECLTYPE(static_cast<targetT>(declval<sourceT>()))>
  :
    true_type
  {
  };
...
struct can_dynamic_cast<targetT, sourceT,
           ASTERIA_VOID_DECLTYPE(dynamic_cast<targetT>(declval<sourceT>()))>
  :
    true_type
  {
  };
