...
#  error Please include <asteria/variant.hpp> instead.
#endif
...
[[noreturn]] ASTERIA_ALWAYS_INLINE
void
...
dispatch_copy_construct(size_t k, void* dptr, const void* sptr)
  {
    ...
    if((max_size > nbytes_eager_copy) || ASTERIA_UNEXPECT(!trivial[k]))
