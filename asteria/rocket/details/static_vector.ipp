...
#ifndef ASTERIA_ROCKET_STATIC_VECTOR_
#  error Please include <asteria/static_vector.hpp> instead.
#endif
...
class storage_handle
  ...
  public:
    ...
    ASTERIA_CONST static constexpr
    size_type
    capacity()
      noexcept
      { return capacityT;  }
    ...
    emplace_back_unchecked(paramsT&&... params)
      {
        ASTERIA_ASSERT_MSG(this->m_nelem < this->capacity(), "no space for new elements");
    ...
    pop_back_unchecked()
      noexcept
      {
        ASTERIA_ASSERT_MSG(this->m_nelem > 0, "no element to pop");
