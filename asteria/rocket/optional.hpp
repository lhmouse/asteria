...
#ifndef ASTERIA_ROCKET_OPTIONAL_
#define ASTERIA_ROCKET_OPTIONAL_
...
class optional
  ...
  public:
    ...
    ASTERIA_ENABLE_IF(is_convertible<yvalueT&&, value_type>::value)>
    ...
    template<typename yvalueT,
    ASTERIA_ENABLE_IF(is_convertible<const typename optional<yvalueT>::value_type&,
                                    value_type>::value)>
    ...
    template<typename yvalueT,
    ASTERIA_ENABLE_IF(is_convertible<typename optional<yvalueT>::value_type&&,
                                    value_type>::value)>
    ...
    template<typename yvalueT,
    ASTERIA_ENABLE_IF(is_assignable<value_type&, yvalueT&&>::value)>
    optional&
    ...
    template<typename yvalueT,
    ASTERIA_ENABLE_IF(is_assignable<value_type&,
                          const typename optional<yvalueT>::value_type&>::value)>
    optional&
