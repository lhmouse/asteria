...
template<typename charT, typename traitsT = char_traits<charT>,
         typename allocatorT = allocator<charT>> class basic_cow_istringstream;

template<typename charT, typename traitsT,
         typename allocatorT> class basic_cow_istringstream : public basic_istream<charT, traitsT>
  {
  public:
  ...
  public:
    ...
    explicit basic_cow_istringstream(const string_type& str, ios_base::openmode which = ios_base::in)
      : stream_type(&(this->m_sb)),
        m_sb()
      {
        this->m_sb.set_string(str, which | ios_base::in);
      }
    explicit basic_cow_istringstream(string_type&& str, ios_base::openmode which = ios_base::in)
      : stream_type(&(this->m_sb)),
        m_sb()
      {
        this->m_sb.set_string(noadl::move(str), which | ios_base::in);
      }
  ...
  public:
    ...
    basic_cow_istringstream& set_string(const string_type& str, ios_base::openmode which = ios_base::in)
      {
        this->m_sb.set_string(str, which | ios_base::in);
        this->clear();
        return *this;
      }
    basic_cow_istringstream& set_string(string_type&& str, ios_base::openmode which = ios_base::in)
      {
        this->m_sb.set_string(noadl::move(str), which | ios_base::in);
        this->clear();
        return *this;
      }
    basic_cow_istringstream& clear_string(ios_base::openmode which = ios_base::in)
      {
        this->m_sb.clear_string(which | ios_base::in);
        this->clear();
        return *this;
      }
    string_type extract_string(ios_base::openmode which = ios_base::in)
      {
        auto str = this->m_sb.extract_string(which | ios_base::in);
        this->clear();
        return str;
      }
...
template<typename charT, typename traitsT,
         typename allocatorT> constexpr typename basic_cow_istringstream<charT, traitsT,
                                                                         allocatorT>::size_type basic_cow_istringstream<charT, traitsT,
                                                                                                                        allocatorT>::npos;
#endif

template<typename charT, typename traitsT,
         typename allocatorT> basic_cow_istringstream<charT, traitsT, allocatorT>::~basic_cow_istringstream()
  = default;
