...
enum Compiler_Status : uint32_t
  {
    ...
    compiler_status_token_character_unrecognized               = 2001,
    compiler_status_string_literal_unclosed                    = 2002,
    compiler_status_escape_sequence_unknown                    = 2003,
    compiler_status_escape_sequence_incomplete                 = 2004,
    compiler_status_escape_sequence_invalid_hex                = 2005,
    compiler_status_escape_utf_code_point_invalid              = 2006,
    compiler_status_numeric_literal_invalid                    = 2007,
    compiler_status_integer_literal_overflow                   = 2008,
    compiler_status_integer_literal_inexact                    = 2009,
    compiler_status_real_literal_overflow                      = 2010,
    compiler_status_real_literal_underflow                     = 2011,
    compiler_status_numeric_literal_suffix_invalid             = 2012,
    compiler_status_block_comment_unclosed                     = 2014,
    compiler_status_digit_separator_following_nondigit         = 2015,
    compiler_status_duplicate_key_in_object                    = 3001,
    compiler_status_identifier_expected                        = 3002,
    compiler_status_semicolon_expected                         = 3003,
    compiler_status_string_literal_expected                    = 3004,
    compiler_status_statement_expected                         = 3005,
    compiler_status_equals_sign_expected                       = 3006,
    compiler_status_expression_expected                        = 3007,
    compiler_status_open_brace_expected                        = 3008,
    compiler_status_closed_brace_or_statement_expected         = 3009,
    compiler_status_open_parenthesis_expected                  = 3010,
    compiler_status_closed_parenthesis_or_comma_expected       = 3011,
    compiler_status_closed_parenthesis_expected                = 3012,
    compiler_status_colon_expected                             = 3013,
    compiler_status_closed_brace_or_switch_clause_expected     = 3014,
    compiler_status_keyword_while_expected                     = 3015,
    compiler_status_keyword_catch_expected                     = 3016,
    compiler_status_comma_expected                             = 3017,
    compiler_status_for_statement_initializer_expected         = 3018,
    compiler_status_semicolon_or_expression_expected           = 3019,
    compiler_status_closed_brace_expected                      = 3020,
    compiler_status_too_many_elements                          = 3021,
    compiler_status_closed_bracket_expected                    = 3022,
    compiler_status_open_brace_or_equal_initializer_expected   = 3023,
    compiler_status_equals_sign_or_colon_expected              = 3024,
    compiler_status_closed_bracket_or_comma_expected           = 3025,
    compiler_status_closed_brace_or_comma_expected             = 3026,
    compiler_status_closed_bracket_or_expression_expected      = 3027,
    compiler_status_closed_brace_or_json5_key_expected         = 3028,
    compiler_status_argument_expected                          = 3029,
    compiler_status_closed_parenthesis_or_argument_expected    = 3030,
    compiler_status_arrow_expected                             = 3031,
    compiler_status_reserved_identifier_not_declarable         = 3032,
    compiler_status_break_no_matching_scope                    = 3033,
    compiler_status_continue_no_matching_scope                 = 3034,
    compiler_status_closed_bracket_or_identifier_expected      = 3035,
    compiler_status_closed_brace_or_identifier_expected        = 3036,
  };
