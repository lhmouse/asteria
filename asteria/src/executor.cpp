...
void Executor::set_root_variable(const std::string &identifier, Stored_value &&value, bool constant){
	// Create a reference.
	Xptr<Variable> var;
...
void Executor::set_root_constant(const std::string &identifier, Stored_value &&value){
