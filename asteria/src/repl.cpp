  ...
  try {
    ...
    if(print_help) {
      ...
      ::printf("Usage: %s [OPTIONS] [[--] FILE [ARGUMENTS]...]\n"
               ...
               "  -I       suppress interactive mode [default is auto-detected]\n"
               "  -i       force interactive mode [default is auto-detected]\n"
               "  -O[LVL]  set optimization level to the integer LVL [default is 2]\n"
               "           (-O0 disables optimization. Because of compatibility reasons, -O\n"
               "           without LVL is equivalent to -O1, not -O2.)\n"
               ...
               "\n"
               "INTERACTIVE MODE AND EXIT STATUS\n"
               "\n"
