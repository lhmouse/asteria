...
Aval std_string_explode(Sval text, Sopt delim, Iopt limit)
  {
    ...
    if(!delim || delim->empty()) {
      ...
      for(size_t i = 0;  i < text.size();  ++i) {
        ...
        segments.emplace_back(Sval(sref(s_char_table[b], 1)));
      }
      return segments;
    }
    // Break `text` down.
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.slice"));
    // Parse arguments.
    Sval text;
    Ival from;
    Iopt length;
    if(reader.I().v(text).v(from).o(length).F()) {
      Reference_root::S_temporary xref =
        { std_string_slice(::std::move(text), from, length) };
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.replace"));
    ...
    if(reader.L(state).o(length).v(replacement).F()) {
      Reference_root::S_temporary xref =
        { std_string_replace_slice(::std::move(text), from, length, ::std::move(replacement)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.compare"));
    // Parse arguments.
    Sval text1;
    Sval text2;
    Iopt length;
    if(reader.I().v(text1).v(text2).o(length).F()) {
      Reference_root::S_temporary xref =
        { std_string_compare(::std::move(text1), ::std::move(text2), length) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.starts_with"));
    // Parse arguments.
    Sval text;
    Sval prefix;
    if(reader.I().v(text).v(prefix).F()) {
      Reference_root::S_temporary xref =
        { std_string_starts_with(::std::move(text), ::std::move(prefix)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.ends_with"));
    // Parse arguments.
    Sval text;
    Sval suffix;
    if(reader.I().v(text).v(suffix).F()) {
      Reference_root::S_temporary xref =
        { std_string_ends_with(::std::move(text), ::std::move(suffix)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.find"));
    Argument_Reader::State state;
    // Parse arguments.
    Sval text;
    Sval pattern;
    if(reader.I().v(text).S(state).v(pattern).F()) {
      Reference_root::S_temporary xref =
        { std_string_find(::std::move(text), 0, nullopt, ::std::move(pattern)) };
      return self = ::std::move(xref);
    }
    Ival from;
    if(reader.L(state).v(from).S(state).v(pattern).F()) {
      Reference_root::S_temporary xref =
        { std_string_find(::std::move(text), from, nullopt, ::std::move(pattern)) };
      return self = ::std::move(xref);
    }
    Iopt length;
    if(reader.L(state).o(length).v(pattern).F()) {
      Reference_root::S_temporary xref =
        { std_string_find(::std::move(text), from, length, ::std::move(pattern)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.rfind"));
    Argument_Reader::State state;
    // Parse arguments.
    Sval text;
    Sval pattern;
    if(reader.I().v(text).S(state).v(pattern).F()) {
      Reference_root::S_temporary xref =
        { std_string_rfind(::std::move(text), 0, nullopt, ::std::move(pattern)) };
      return self = ::std::move(xref);
    }
    Ival from;
    if(reader.L(state).v(from).S(state).v(pattern).F()) {
      Reference_root::S_temporary xref =
        { std_string_rfind(::std::move(text), from, nullopt, ::std::move(pattern)) };
      return self = ::std::move(xref);
    }
    Iopt length;
    if(reader.L(state).o(length).v(pattern).F()) {
      Reference_root::S_temporary xref =
        { std_string_rfind(::std::move(text), from, length, ::std::move(pattern)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.find_and_replace"));
    Argument_Reader::State state;
    // Parse arguments.
    Sval text;
    Sval pattern;
    ...
    if(reader.I().v(text).S(state).v(pattern).v(replacement).F()) {
      Reference_root::S_temporary xref =
        { std_string_find_and_replace(::std::move(text), 0, nullopt, ::std::move(pattern), ::std::move(replacement)) };
      return self = ::std::move(xref);
    }
    Ival from;
    if(reader.L(state).v(from).S(state).v(pattern).v(replacement).F()) {
      Reference_root::S_temporary xref =
        { std_string_find_and_replace(::std::move(text), from, nullopt, ::std::move(pattern), ::std::move(replacement)) };
      return self = ::std::move(xref);
    }
    Iopt length;
    if(reader.L(state).o(length).v(pattern).v(replacement).F()) {
      Reference_root::S_temporary xref =
        { std_string_find_and_replace(::std::move(text), from, length, ::std::move(pattern), ::std::move(replacement)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.find_any_of"));
    Argument_Reader::State state;
    // Parse arguments.
    Sval text;
    Sval accept;
    if(reader.I().v(text).S(state).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_find_any_of(::std::move(text), 0, nullopt, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    Ival from;
    if(reader.L(state).v(from).S(state).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_find_any_of(::std::move(text), from, nullopt, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    Iopt length;
    if(reader.L(state).o(length).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_find_any_of(::std::move(text), from, length, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.rfind_any_of"));
    Argument_Reader::State state;
    // Parse arguments.
    Sval text;
    Sval accept;
    if(reader.I().v(text).S(state).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_rfind_any_of(::std::move(text), 0, nullopt, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    Ival from;
    if(reader.L(state).v(from).S(state).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_rfind_any_of(::std::move(text), from, nullopt, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    Iopt length;
    if(reader.L(state).o(length).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_rfind_any_of(::std::move(text), from, length, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.find_not_of"));
    Argument_Reader::State state;
    // Parse arguments.
    Sval text;
    Sval accept;
    if(reader.I().v(text).S(state).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_find_not_of(::std::move(text), 0, nullopt, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    Ival from;
    if(reader.L(state).v(from).S(state).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_find_not_of(::std::move(text), from, nullopt, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    Iopt length;
    if(reader.L(state).o(length).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_find_not_of(::std::move(text), from, length, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.rfind_not_of"));
    Argument_Reader::State state;
    // Parse arguments.
    Sval text;
    Sval accept;
    if(reader.I().v(text).S(state).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_rfind_not_of(::std::move(text), 0, nullopt, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    Ival from;
    if(reader.L(state).v(from).S(state).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_rfind_not_of(::std::move(text), from, nullopt, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    Iopt length;
    if(reader.L(state).o(length).v(accept).F()) {
      Reference_root::S_temporary xref =
        { std_string_rfind_not_of(::std::move(text), from, length, ::std::move(accept)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.reverse"));
    // Parse arguments.
    Sval text;
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.trim"));
    // Parse arguments.
    Sval text;
    Sopt reject;
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.triml"));
    // Parse arguments.
    Sval text;
    Sopt reject;
    if(reader.I().v(text).o(reject).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.trimr"));
    // Parse arguments.
    Sval text;
    Sopt reject;
    if(reader.I().v(text).o(reject).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.padl"));
    // Parse arguments.
    Sval text;
    Ival length;
    Sopt padding;
    if(reader.I().v(text).v(length).o(padding).F()) {
      Reference_root::S_temporary xref =
        { std_string_padl(::std::move(text), length, ::std::move(padding)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.padr"));
    // Parse arguments.
    Sval text;
    Ival length;
    Sopt padding;
    if(reader.I().v(text).v(length).o(padding).F()) {
      Reference_root::S_temporary xref =
        { std_string_padr(::std::move(text), length, ::std::move(padding)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.to_upper"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.to_lower"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.translate"));
    // Parse arguments.
    Sval text;
    Sval inputs;
    Sopt outputs;
    if(reader.I().v(text).v(inputs).o(outputs).F()) {
      Reference_root::S_temporary xref =
        { std_string_translate(::std::move(text), ::std::move(inputs), ::std::move(outputs)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.explode"));
    // Parse arguments.
    Sval text;
    Sopt delim;
    Iopt limit;
    if(reader.I().v(text).o(delim).o(limit).F()) {
      Reference_root::S_temporary xref =
        { std_string_explode(::std::move(text), ::std::move(delim), limit) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.implode"));
    // Parse arguments.
    Aval segments;
    Sopt delim;
    if(reader.I().v(segments).o(delim).F()) {
      Reference_root::S_temporary xref =
        { std_string_implode(::std::move(segments), ::std::move(delim)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.hex_encode"));
    // Parse arguments.
    Sval data;
    Bopt lowercase;
    Sopt delim;
    if(reader.I().v(data).o(lowercase).o(delim).F()) {
      Reference_root::S_temporary xref =
        { std_string_hex_encode(::std::move(data), lowercase, ::std::move(delim)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.hex_decode"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.base32_encode"));
    // Parse arguments.
    Sval data;
    Bopt lowercase;
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.base32_decode"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.base64_encode"));
    // Parse arguments.
    Sval data;
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.base64_decode"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.url_encode"));
    // Parse arguments.
    Sval data;
    Bopt lowercase;
    if(reader.I().v(data).o(lowercase).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.url_decode"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.utf8_validate"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.utf8_encode"));
    // Parse arguments.
    Ival code_point;
    Bopt permissive;
    if(reader.I().v(code_point).o(permissive).F()) {
      Reference_root::S_temporary xref =
        { std_string_utf8_encode(::std::move(code_point), ::std::move(permissive)) };
      return self = ::std::move(xref);
    }
    Aval code_points;
    if(reader.I().v(code_points).o(permissive).F()) {
      Reference_root::S_temporary xref =
        { std_string_utf8_encode(::std::move(code_points), ::std::move(permissive)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.utf8_decode"));
    // Parse arguments.
    Sval text;
    Bopt permissive;
    if(reader.I().v(text).o(permissive).F()) {
      Reference_root::S_temporary xref =
        { std_string_utf8_decode(::std::move(text), ::std::move(permissive)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.pack_8"));
    // Parse arguments.
    Ival value;
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.unpack_8"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.pack_16be"));
    // Parse arguments.
    Ival value;
    if(reader.I().v(value).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.unpack_16be"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.pack_16le"));
    // Parse arguments.
    Ival value;
    if(reader.I().v(value).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.unpack_16le"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.pack_32be"));
    // Parse arguments.
    Ival value;
    if(reader.I().v(value).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.unpack_32be"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.pack_32le"));
    // Parse arguments.
    Ival value;
    if(reader.I().v(value).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.unpack_32le"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.pack_64be"));
    // Parse arguments.
    Ival value;
    if(reader.I().v(value).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.unpack_64be"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.pack_64le"));
    // Parse arguments.
    Ival value;
    if(reader.I().v(value).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.unpack_64le"));
    // Parse arguments.
    Sval text;
    if(reader.I().v(text).F()) {
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.format"));
    // Parse arguments.
    Sval templ;
    ...
    //===================================================================
    result.insert_or_assign(sref("regex_find"),
      Fval(
"""""""""""""""""""""""""""""""""""""""""""""""" R"'''''''''''''''(
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.regex_find"));
    Argument_Reader::State state;
    // Parse arguments.
    Sval text;
    Sval pattern;
    ...
    //===================================================================
    result.insert_or_assign(sref("regex_match"),
      Fval(
"""""""""""""""""""""""""""""""""""""""""""""""" R"'''''''''''''''(
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.regex_match"));
    Argument_Reader::State state;
    // Parse arguments.
    Sval text;
    Sval pattern;
    if(reader.I().v(text).S(state).v(pattern).F()) {
      Reference_root::S_temporary xref =
        { std_string_regex_match(::std::move(text), 0, nullopt, ::std::move(pattern)) };
      return self = ::std::move(xref);
    }
    Ival from;
    if(reader.L(state).v(from).S(state).v(pattern).F()) {
      Reference_root::S_temporary xref =
        { std_string_regex_match(::std::move(text), from, nullopt, ::std::move(pattern)) };
      return self = ::std::move(xref);
    }
    Iopt length;
    if(reader.L(state).o(length).v(pattern).F()) {
      Reference_root::S_temporary xref =
        { std_string_regex_match(::std::move(text), from, length, ::std::move(pattern)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
    ...
    //===================================================================
    result.insert_or_assign(sref("regex_replace"),
      Fval(
"""""""""""""""""""""""""""""""""""""""""""""""" R"'''''''''''''''(
...
*[](Reference& self, cow_vector<Reference>&& args, Global& /*global*/) -> Reference&
  {
    Argument_Reader reader(::rocket::ref(args), sref("std.string.regex_replace"));
    Argument_Reader::State state;
    // Parse arguments.
    Sval text;
    Sval pattern;
    ...
    if(reader.I().v(text).S(state).v(pattern).v(replacement).F()) {
      Reference_root::S_temporary xref =
        { std_string_regex_replace(::std::move(text), 0, nullopt, ::std::move(pattern), ::std::move(replacement)) };
      return self = ::std::move(xref);
    }
    Ival from;
    if(reader.L(state).v(from).S(state).v(pattern).v(replacement).F()) {
      Reference_root::S_temporary xref =
        { std_string_regex_replace(::std::move(text), from, nullopt, ::std::move(pattern), ::std::move(replacement)) };
      return self = ::std::move(xref);
    }
    Iopt length;
    if(reader.L(state).o(length).v(pattern).v(replacement).F()) {
      Reference_root::S_temporary xref =
        { std_string_regex_replace(::std::move(text), from, length, ::std::move(pattern), ::std::move(replacement)) };
      return self = ::std::move(xref);
    }
    // Fail.
    reader.throw_no_matching_function_call();
