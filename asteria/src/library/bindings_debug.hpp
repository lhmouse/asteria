...
extern bool std_debug_print(const G_string& templ, const cow_vector<Value>& values);
extern bool std_debug_dump(const Value& value, const opt<G_integer>& indent = rocket::clear);
