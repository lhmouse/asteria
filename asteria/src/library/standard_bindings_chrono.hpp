...
#ifndef ASTERIA_LIBRARY_STANDARD_BINDINGS_CHRONO_HPP_
#define ASTERIA_LIBRARY_STANDARD_BINDINGS_CHRONO_HPP_
...
extern D_object create_standard_bindings_chrono();
