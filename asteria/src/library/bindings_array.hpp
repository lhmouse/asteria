...
extern Opt<D_integer> std_array_find(const D_array& data, const D_integer& from, const Value& target);
extern Opt<D_integer> std_array_find(const D_array& data, const D_integer& from, const Opt<D_integer>& length, const Value& target);
extern Opt<D_integer> std_array_rfind(const D_array& data, const Value& target);
extern Opt<D_integer> std_array_rfind(const D_array& data, const D_integer& from, const Value& target);
extern Opt<D_integer> std_array_rfind(const D_array& data, const D_integer& from, const Opt<D_integer>& length, const Value& target);

extern Opt<D_integer> std_array_find_if(const Global_Context& global, const D_array& data, const D_function& predictor);
extern Opt<D_integer> std_array_find_if(const Global_Context& global, const D_array& data, const D_integer& from, const D_function& predictor);
extern Opt<D_integer> std_array_find_if(const Global_Context& global, const D_array& data, const D_integer& from, const Opt<D_integer>& length, const D_function& predictor);
extern Opt<D_integer> std_array_find_if_not(const Global_Context& global, const D_array& data, const D_function& predictor);
extern Opt<D_integer> std_array_find_if_not(const Global_Context& global, const D_array& data, const D_integer& from, const D_function& predictor);
extern Opt<D_integer> std_array_find_if_not(const Global_Context& global, const D_array& data, const D_integer& from, const Opt<D_integer>& length, const D_function& predictor);
extern Opt<D_integer> std_array_rfind_if(const Global_Context& global, const D_array& data, const D_function& predictor);
extern Opt<D_integer> std_array_rfind_if(const Global_Context& global, const D_array& data, const D_integer& from, const D_function& predictor);
extern Opt<D_integer> std_array_rfind_if(const Global_Context& global, const D_array& data, const D_integer& from, const Opt<D_integer>& length, const D_function& predictor);
extern Opt<D_integer> std_array_rfind_if_not(const Global_Context& global, const D_array& data, const D_function& predictor);
extern Opt<D_integer> std_array_rfind_if_not(const Global_Context& global, const D_array& data, const D_integer& from, const D_function& predictor);
extern Opt<D_integer> std_array_rfind_if_not(const Global_Context& global, const D_array& data, const D_integer& from, const Opt<D_integer>& length, const D_function& predictor);
