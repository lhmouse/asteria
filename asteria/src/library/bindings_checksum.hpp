...
extern Ival std_checksum_crc32_new_write(Pval& h, Sval data);
...
extern Ival std_checksum_fnv1a32_new_write(Pval& h, Sval data);
...
extern Ival std_checksum_md5_new_write(Pval& h, Sval data);
...
extern Ival std_checksum_sha1_new_write(Pval& h, Sval data);
...
extern Ival std_checksum_sha256_new_write(Pval& h, Sval data);
