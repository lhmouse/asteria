...
extern G_integer std_checksum_crc32(aref<G_string> data);

extern G_object std_checksum_fnv1a32_new();
extern G_integer std_checksum_fnv1a32(aref<G_string> data);

extern G_object std_checksum_md5_new();
extern G_string std_checksum_md5(aref<G_string> data);

extern G_object std_checksum_sha1_new();
extern G_string std_checksum_sha1(aref<G_string> data);

extern G_object std_checksum_sha256_new();
extern G_string std_checksum_sha256(aref<G_string> data);
