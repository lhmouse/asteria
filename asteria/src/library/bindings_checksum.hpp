...
extern void std_checksum_crc32_new_write(Pval& self, Sval data);
extern Ival std_checksum_crc32_new_finish(Pval& self);
extern Oval std_checksum_crc32_new();
extern Ival std_checksum_crc32(Sval data);

extern Pval std_checksum_fnv1a32_new_private();
extern void std_checksum_fnv1a32_new_write(Pval& self, Sval data);
extern Ival std_checksum_fnv1a32_new_finish(Pval& self);
extern Oval std_checksum_fnv1a32_new();
extern Ival std_checksum_fnv1a32(Sval data);

extern Pval std_checksum_md5_new_private();
extern void std_checksum_md5_new_write(Pval& self, Sval data);
extern Sval std_checksum_md5_new_finish(Pval& self);
extern Oval std_checksum_md5_new();
extern Sval std_checksum_md5(Sval data);

extern Pval std_checksum_sha1_new_private();
extern void std_checksum_sha1_new_write(Pval& self, Sval data);
extern Sval std_checksum_sha1_new_finish(Pval& self);
extern Oval std_checksum_sha1_new();
extern Sval std_checksum_sha1(Sval data);

extern Pval std_checksum_sha256_new_private();
extern void std_checksum_sha256_new_write(Pval& self, Sval data);
extern Sval std_checksum_sha256_new_finish(Pval& self);
