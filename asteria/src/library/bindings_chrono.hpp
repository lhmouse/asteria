...
extern G_integer std_chrono_local_from_utc(G_integer time_utc);
extern G_integer std_chrono_utc_from_local(G_integer time_local);
extern G_string std_chrono_utc_format(G_integer time_point, opt<G_boolean> with_ms = ::rocket::clear);
extern opt<G_integer> std_chrono_utc_parse(G_string time_str);
