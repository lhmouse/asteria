...
private:
	...
	C_cow_string m_source_location;
...
public:
	Instantiated_function(const char *category, C_cow_string source_location, Sptr_vector<const Parameter> parameters_opt, Sptr<const Scope> bound_scope, Xptr<Block> &&bound_body_opt)
