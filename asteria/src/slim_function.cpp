...
void Slim_function::invoke(Vp<Reference> &result_out, Spr<Recycler> recycler_inout, Vp<Reference> &&this_opt, Vp_vector<Reference> &&arguments_opt) const {
	return (*m_target)(result_out, recycler_inout, std::move(this_opt), std::move(arguments_opt));
}
