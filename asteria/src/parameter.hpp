...
private:
	...
	Sptr<const Value> m_default_argument_opt;

public:
	Parameter(Cow_string identifier, Sptr<const Value> default_argument_opt)
...
public:
	...
	const Sptr<const Value> & get_default_argument_opt() const {
