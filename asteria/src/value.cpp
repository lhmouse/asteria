...
using Rbr_Element = variant<Rbr_array, Rbr_object>;

}  // namespace

template class variant<ASTERIA_TYPES_AIXE9XIG_(V)>;
template class optional<Value>;
template class cow_vector<Value>;
template class cow_hashmap<phcow_string, Value, phcow_string::hash>;
