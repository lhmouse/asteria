...
namespace {
	...
	public:
		Argument_getter(const D_string &self_id, const D_string &source_location, Vp_vector<Reference> &&arguments_opt)
			: m_self_id(self_id), m_source_location(source_location), m_arguments_opt(std::move(arguments_opt))
		{ }
