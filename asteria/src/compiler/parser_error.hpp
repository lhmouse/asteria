    ...
    enum Code : std::uint32_t
      {
        ...
        code_close_brace_or_statement_expected          = 4009,
        code_open_parenthesis_expected                  = 4010,
        code_close_parenthesis_or_parameter_expected    = 4011,
        code_close_parenthesis_expected                 = 4012,
        code_colon_expected                             = 4013,
        code_close_brace_or_switch_clause_expected      = 4014,
        ...
        code_close_bracket_or_expression_expected       = 4019,
        code_close_brace_or_object_key_expected         = 4020,
        code_duplicate_object_key                       = 4021,
        code_close_parenthesis_or_argument_expected     = 4022,
