      ...
      case index_block:
        {
          ...
          if(all_of(qblock->stmts, [](const Statement& st) { return st.is_scopeless();  })) {
      ...
      case index_if:
        {
          ...
          ASTERIA_ASSERT(!altr.cond.units.empty());
      ...
      case index_switch:
        {
          ...
          ASTERIA_ASSERT(!altr.ctrl.units.empty());
      ...
      case index_for_each:
        {
          ...
          ASTERIA_ASSERT(!altr.init.units.empty());
      ...
      case index_throw:
        {
          ...
          ASTERIA_ASSERT(!altr.expr.units.empty());
