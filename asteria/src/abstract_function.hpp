...
class Abstract_Function : public Rcfwd<Abstract_Function>
  ...
  public:
    ...
    Reference& invoke(Reference& self, Global_Context& global, cow_vector<Reference>&& args = nullopt) const;
    Reference invoke(Global_Context& global, cow_vector<Reference>&& args = nullopt) const;
  };
