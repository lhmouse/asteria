...
class Block
  ...
  public:
    ...
    using Compiled_Instruction =
      rocket::bind_front_result<
        Status (*)(const void *,
                   const std::tuple<Reference &, Executive_Context &, Global_Context &, const CoW_String &> &),
        const void *>;
  ...
  public:
    ...
    Status execute_in_place(Reference &ref_out, Executive_Context &ctx_io, Global_Context &global, const CoW_String &func) const;

    Block bind(const Global_Context &global, const Analytic_Context &ctx) const;
    Status execute(Reference &ref_out, Global_Context &global, const CoW_String &func, const Executive_Context &ctx) const;
