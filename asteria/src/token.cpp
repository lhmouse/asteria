...
namespace {
	...
	Parser_result do_get_token(Deque<Token> &tokens_out, std::size_t line, const Cow_string &str, std::size_t column){
...
Parser_result tokenize_line(Deque<Token> &tokens_out, std::size_t line, const Cow_string &str){
