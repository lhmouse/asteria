...
const Reference * Global_context::get_named_reference_opt(const rocket::prehashed_string &name) const
  {
...
Reference & Global_context::open_named_reference(const rocket::prehashed_string &name)
  {
