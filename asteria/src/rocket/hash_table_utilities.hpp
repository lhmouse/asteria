...
template<typename bucketT> inline bucketT * get_probing_origin(bucketT *begin, bucketT *end,
...
template<typename bucketT, typename predT> inline bucketT * linear_probe(bucketT *begin, bucketT *to, bucketT *from, bucketT *end,
