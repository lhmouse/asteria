...
template<typename charT, typename traitsT = char_traits<charT>, typename allocatorT = allocator<charT>> class basic_insertable_istream;

template<typename charT, typename traitsT, typename allocatorT> class basic_insertable_istream : public basic_istream<charT, traitsT>
  {
  public:
  ...
  public:
    explicit basic_insertable_istream(string_type str, size_type caret = npos, ios_base::openmode which = ios_base::in)
      : basic_istream<char_type, traits_type>(&(this->m_sb)),
        m_sb(noadl::move(str), caret, which | ios_base::in)
      {
      }
...
template<typename charT, typename traitsT, typename allocatorT> constexpr typename basic_insertable_istream<charT, traitsT, allocatorT>::size_type basic_insertable_istream<charT, traitsT, allocatorT>::npos;
#endif

template<typename charT, typename traitsT, typename allocatorT> basic_insertable_istream<charT, traitsT, allocatorT>::~basic_insertable_istream()
  = default;
