...
template<typename keyT, typename mappedT,
         typename hashT = hash<keyT>, typename eqT = equal_to<keyT>,
         typename allocatorT = allocator<pair<const keyT, mappedT>>
         > class cow_hashmap;
...
template<typename keyT, typename mappedT, typename hashT, typename eqT, typename allocatorT> inline void swap(cow_hashmap<keyT, mappedT, hashT, eqT, allocatorT> &lhs,
