...
int main()
  {
    ...
    cbuf.set_string(::rocket::sref(
      R"__(
        ...
        assert std.numeric.parse_integer("+0x4321") == +17185;
        assert std.numeric.parse_integer("-0x4321") == -17185;
        try { std.numeric.parse_integer(" 999999999999999999999999999999");  assert false;  } catch(e);
        try { std.numeric.parse_integer("+999999999999999999999999999999");  assert false;  } catch(e);
        try { std.numeric.parse_integer("-999999999999999999999999999999");  assert false;  } catch(e);
        try { std.numeric.parse_integer(" 1e100");  assert false;  } catch(e);
        try { std.numeric.parse_integer("+1e100");  assert false;  } catch(e);
        try { std.numeric.parse_integer("-1e100");  assert false;  } catch(e);
        ...
        assert std.numeric.parse_real("+infinity") == +infinity;
        assert std.numeric.parse_real("-infinity") == -infinity;
        try { std.numeric.parse_real(" Infinity");  assert false;  } catch(e);
        try { std.numeric.parse_real("+Infinity");  assert false;  } catch(e);
        try { std.numeric.parse_real("-Infinity");  assert false;  } catch(e);
        assert __isnan std.numeric.parse_real(" nan");
        assert __isnan std.numeric.parse_real("+nan");
        assert __isnan std.numeric.parse_real("-nan");
        try { std.numeric.parse_real(" NaN");  assert false;  } catch(e);
        try { std.numeric.parse_real("+NaN");  assert false;  } catch(e);
        try { std.numeric.parse_real("-NaN");  assert false;  } catch(e);
        ...
        assert std.numeric.parse_real("+0x43.21p3") == +537.03125;
        assert std.numeric.parse_real("-0x43.21p3") == -537.03125;
        try { std.numeric.parse_real(" 1e1000000");  assert false;  } catch(e);
        try { std.numeric.parse_real("+1e1000000");  assert false;  } catch(e);
        try { std.numeric.parse_real("-1e1000000");  assert false;  } catch(e);
