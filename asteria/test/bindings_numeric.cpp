...
int main()
  {
    static constexpr char s_source[] =
      R"__(
        ...
        assert std.numeric.format(-0x1234, 16) == "-0x1234";
        assert std.numeric.format(+0x1234,  2,  2) == "0b10010001101p+2";
        assert std.numeric.format(-0x1234,  2,  2) == "-0b10010001101p+2";
        assert std.numeric.format(+0x1234, 10,  2) == "1165p+2";
        assert std.numeric.format(-0x1234, 10,  2) == "-1165p+2";
        assert std.numeric.format(+0x1234, 16,  2) == "0x48Dp+2";
        assert std.numeric.format(-0x1234, 16,  2) == "-0x48Dp+2";
        assert std.numeric.format(+0x1234,  2, 10) == "0b111010010e+1";
        assert std.numeric.format(-0x1234,  2, 10) == "-0b111010010e+1";
        assert std.numeric.format(+0x1234, 10, 10) == "466e+1";
        assert std.numeric.format(-0x1234, 10, 10) == "-466e+1";
        ...
        assert std.numeric.format(-0x0.0123C, 16) == "-0x0.0123C";
        assert std.numeric.format(+0x123.C,  2,  2) == "0b1.0010001111p+8";
        assert std.numeric.format(-0x123.C,  2,  2) == "-0b1.0010001111p+8";
        assert std.numeric.format(+0x123.C, 10,  2) == "1.1396484375p+8";
        assert std.numeric.format(-0x123.C, 10,  2) == "-1.1396484375p+8";
        assert std.numeric.format(+0x123.C, 16,  2) == "0x1.23Cp+8";
        assert std.numeric.format(-0x123.C, 16,  2) == "-0x1.23Cp+8";
