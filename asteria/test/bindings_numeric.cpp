...
int main()
  {
    ...
    cbuf.set_string(::rocket::sref(
      R"__(
        ...
        assert std.numeric.rotl(12, 0b1011011101111011111, -40) == 0b111110111101;
        assert std.numeric.rotl(12, 0b1011011101111011111, -28) == 0b111110111101;
        assert std.numeric.rotl(12, 0b1011011101111011111, -16) == 0b111110111101;
        assert std.numeric.rotl(12, 0b1011011101111011111,  -4) == 0b111110111101;
        assert std.numeric.rotl(12, 0b1011011101111011111,  -3) == 0b111101111011;
        assert std.numeric.rotl(12, 0b1011011101111011111,  -2) == 0b111011110111;
        assert std.numeric.rotl(12, 0b1011011101111011111,  -1) == 0b110111101111;
        assert std.numeric.rotl(12, 0b1011011101111011111,   0) == 0b101111011111;
        assert std.numeric.rotl(12, 0b1011011101111011111,   1) == 0b011110111111;
        assert std.numeric.rotl(12, 0b1011011101111011111,   2) == 0b111101111110;
        assert std.numeric.rotl(12, 0b1011011101111011111,   3) == 0b111011111101;
        assert std.numeric.rotl(12, 0b1011011101111011111,   4) == 0b110111111011;
        assert std.numeric.rotl(12, 0b1011011101111011111,  16) == 0b110111111011;
        assert std.numeric.rotl(12, 0b1011011101111011111,  28) == 0b110111111011;
        assert std.numeric.rotl(12, 0b1011011101111011111,  40) == 0b110111111011;
        assert std.numeric.rotl(0, 0b1011011101111011111, 40) == 0;
        assert std.numeric.rotl(64, 0x76543210ABCDEF98, 12) == 0x43210ABCDEF98765;

        assert std.numeric.rotr(12, 0b1011011101111011111, -40) == 0b110111111011;
        assert std.numeric.rotr(12, 0b1011011101111011111, -28) == 0b110111111011;
        assert std.numeric.rotr(12, 0b1011011101111011111, -16) == 0b110111111011;
        assert std.numeric.rotr(12, 0b1011011101111011111,  -4) == 0b110111111011;
        assert std.numeric.rotr(12, 0b1011011101111011111,  -3) == 0b111011111101;
        assert std.numeric.rotr(12, 0b1011011101111011111,  -2) == 0b111101111110;
        assert std.numeric.rotr(12, 0b1011011101111011111,  -1) == 0b011110111111;
        assert std.numeric.rotr(12, 0b1011011101111011111,   0) == 0b101111011111;
        assert std.numeric.rotr(12, 0b1011011101111011111,   1) == 0b110111101111;
        assert std.numeric.rotr(12, 0b1011011101111011111,   2) == 0b111011110111;
        assert std.numeric.rotr(12, 0b1011011101111011111,   3) == 0b111101111011;
        assert std.numeric.rotr(12, 0b1011011101111011111,   4) == 0b111110111101;
        assert std.numeric.rotr(12, 0b1011011101111011111,  16) == 0b111110111101;
        assert std.numeric.rotr(12, 0b1011011101111011111,  28) == 0b111110111101;
        assert std.numeric.rotr(12, 0b1011011101111011111,  40) == 0b111110111101;
        assert std.numeric.rotr(0, 0b1011011101111011111, 40) == 0;
