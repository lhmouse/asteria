...
int main()
  {
    ...
    auto val = ref.read();
    ASTERIA_TEST_CHECK(val.dtype() == dtype_string);
    ...
    val = ref.read();
    ASTERIA_TEST_CHECK(val.dtype() == dtype_integer);
    ...
    val = ref.read();
    ASTERIA_TEST_CHECK(val.dtype() == dtype_null);
    ...
    val = ref.read();
    ASTERIA_TEST_CHECK(val.dtype() == dtype_real);
