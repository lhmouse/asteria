...
int main(){
	...
	set_value(value, recycler, D_double(1.5));
	...
	D_array array;
	set_value(value, recycler, D_boolean(true));
	array.emplace_back(std::move(value));
	set_value(value, recycler, D_string(D_string::shallow("world")));
	array.emplace_back(std::move(value));
	...
	set_value(value, recycler, D_boolean(false));
	set_value(cmp, recycler, D_boolean(true));
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_less);
	swap(value, cmp);
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_greater);
	...
	set_value(value, recycler, D_integer(5));
	set_value(cmp, recycler, D_integer(6));
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_less);
	swap(value, cmp);
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_greater);

	set_value(value, recycler, D_integer(3));
	set_value(cmp, recycler, D_integer(3));
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_equal);
	swap(value, cmp);
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_equal);

	set_value(value, recycler, D_double(-2.5));
	set_value(cmp, recycler, D_double(11.0));
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_less);
	swap(value, cmp);
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_greater);

	set_value(value, recycler, D_double(1.0));
	set_value(cmp, recycler, D_double(NAN));
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_unordered);
	swap(value, cmp);
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_unordered);

	set_value(value, recycler, D_string(D_string::shallow("hello")));
	set_value(cmp, recycler, D_string(D_string::shallow("world")));
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_less);
	swap(value, cmp);
	ASTERIA_TEST_CHECK(compare_values(value, cmp) == Value::comparison_result_greater);
