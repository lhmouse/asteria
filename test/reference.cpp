...
int main()
  {
    ...
    ASTERIA_TEST_CHECK(val.index() == Value::type_string);
    ...
    ASTERIA_TEST_CHECK(val.index() == Value::type_integer);
    ...
    val = read_reference(ref);
    ASTERIA_TEST_CHECK(val.index() == Value::type_boolean);
    ...
    val = read_reference(ref);
    ASTERIA_TEST_CHECK(val.index() == Value::type_null);
    ...
    val = read_reference(ref);
    ASTERIA_TEST_CHECK(val.index() == Value::type_double);
