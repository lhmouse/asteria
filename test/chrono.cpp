...
///////////////////////////////////////////////////////////////////////////////
        ...
        assert std.chrono.format(0, 0) == "1970-01-01 00:00:00 UTC";

        assert std.chrono.format_ms(std.numeric.integer_min) == "0000-01-01 00:00:00.000 UTC";  // min
        assert std.chrono.format_ms(std.numeric.integer_max) == "9999-01-01 00:00:00.000 UTC";  // max
        assert std.chrono.format_ms(0, 0) == "1970-01-01 00:00:00.000 UTC";
        ...
        var now_str_utc = std.chrono.format_ms(now, 0);
        std.io.putfln("now_str_utc ---> $1", now_str_utc);
        assert std.chrono.parse(now_str_utc) == now;

        var now_str_local = std.chrono.format_ms(now);
        ...
        for(var i = 0;  i < 365 * 500;  ++i) {
          t += 86345`678;
          assert std.chrono.parse(std.chrono.format_ms(t)) == t;
        }
