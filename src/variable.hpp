...
extern Xptr<Variable> set_variable_opt(Xptr<Variable> &variable_out, Spref<Recycler> recycler, Stored_value &&value_opt);
extern Xptr<Variable> copy_variable_recursive_opt(Xptr<Variable> &variable_out, Spref<Recycler> recycler, Spref<const Variable> source_opt);
